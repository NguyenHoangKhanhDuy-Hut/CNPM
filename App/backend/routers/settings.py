...
def get_settings(current_user: UserResponse = Depends(get_admin_user)):
...
def delete_backend_setting(key: str, current_user: UserResponse = Depends(get_admin_user)):
...
def delete_frontend_setting(key: str, current_user: UserResponse = Depends(get_admin_user)):
